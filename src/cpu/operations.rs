...
use crate::cpu::template::{template_add_a, template_add_hl, template_dec_value, template_dec_wide, template_inc_value, template_inc_wide, template_ld};
...
pub static INSTRUCTIONS: [GenericInstruction; 144] = [
    ...
    GenericInstruction::VOID(   Instruction { opcode: 0x85, disassembly: "ADD A, L"    , byte_size: 1, clock_tick: 4 , function: add_a_j }),
    ...
    GenericInstruction::VOID(   Instruction { opcode: 0x80, disassembly: "ADDC A, B"   , byte_size: 1, clock_tick: 4 , function: addc_a_b }),
    GenericInstruction::VOID(   Instruction { opcode: 0x81, disassembly: "ADDC A, C"   , byte_size: 1, clock_tick: 4 , function: addc_a_c }),
    GenericInstruction::VOID(   Instruction { opcode: 0x82, disassembly: "ADDC A, D"   , byte_size: 1, clock_tick: 4 , function: addc_a_d }),
    GenericInstruction::VOID(   Instruction { opcode: 0x83, disassembly: "ADDC A, E"   , byte_size: 1, clock_tick: 4 , function: addc_a_e }),
    GenericInstruction::VOID(   Instruction { opcode: 0x84, disassembly: "ADDC A, H"   , byte_size: 1, clock_tick: 4 , function: addc_a_h }),
    GenericInstruction::VOID(   Instruction { opcode: 0x85, disassembly: "ADDC A, L"   , byte_size: 1, clock_tick: 4 , function: addc_a_l }),
    GenericInstruction::VOID(   Instruction { opcode: 0x86, disassembly: "ADDC A, (HL)", byte_size: 1, clock_tick: 8 , function: addc_a_hl_addr }),
    GenericInstruction::VOID(   Instruction { opcode: 0x87, disassembly: "ADDC A, A"   , byte_size: 1, clock_tick: 4 , function: addc_a_a }),
];
